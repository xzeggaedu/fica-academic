...
class TestCatalogCourseValidation:
    ...
    def test_course_code_validation_valid(self):
        ...
        course = CatalogCourseBase(
            course_code="CS101", course_name="Introducción a la Programación", department_code="CS", is_active=True
        )
    ...
    def test_course_code_uppercase_normalization(self):
        ...
        course = CatalogCourseBase(course_code="cs101", course_name="Test Course", department_code="cs", is_active=True)
    ...
    def test_course_code_no_spaces(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            CatalogCourseBase(course_code="CS 101", course_name="Test Course", department_code="CS", is_active=True)
    ...
    def test_department_code_no_spaces(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            CatalogCourseBase(course_code="CS101", course_name="Test Course", department_code="C S", is_active=True)
    ...
    def test_course_code_required(self):
        ...
        with pytest.raises(ValidationError):
            CatalogCourseBase(course_name="Test Course", department_code="CS", is_active=True)

    def test_course_name_required(self):
        """Prueba que course_name sea requerido."""
        with pytest.raises(ValidationError):
            CatalogCourseBase(course_code="CS101", department_code="CS", is_active=True)

    def test_department_code_required(self):
        """Prueba que department_code sea requerido."""
        with pytest.raises(ValidationError):
            CatalogCourseBase(course_code="CS101", course_name="Test Course", is_active=True)

    def test_is_active_default_value(self):
        """Prueba que is_active tenga valor por defecto True."""
        course = CatalogCourseBase(course_code="CS101", course_name="Test Course", department_code="CS")
...
class TestCatalogCourseCreate:
    ...
    def test_create_course_without_schools(self):
        ...
        course_data = CatalogCourseCreate(
            course_code="CS101", course_name="Introducción a la Programación", department_code="CS"
        )
    ...
    def test_create_course_with_empty_school_list(self):
        ...
        course_data = CatalogCourseCreate(
            course_code="CS101", course_name="Introducción a la Programación", department_code="CS", school_ids=[]
        )
...
class TestCatalogCourseUpdate:
    ...
    def test_update_course_schools_only(self):
        ...
        update_data = CatalogCourseUpdate(school_ids=[1, 2])
    ...
    def test_update_course_code_normalization(self):
        ...
        update_data = CatalogCourseUpdate(course_code="cs102")
    ...
    def test_update_course_code_no_spaces(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            CatalogCourseUpdate(course_code="CS 102")

        assert "El código del curso no puede contener espacios" in str(exc_info.value)
...
class TestCourseCodeValidation:
    ...
    def test_valid_course_codes(self):
        ...
        for code in valid_codes:
            course = CatalogCourseBase(course_code=code, course_name="Test Course", department_code="TEST")
    ...
    def test_course_code_min_length(self):
        ...
        with pytest.raises(ValidationError):
            CatalogCourseBase(course_code="", course_name="Test Course", department_code="CS")
...
class TestCourseNameValidation:
    ...
    def test_course_name_min_length(self):
        ...
        with pytest.raises(ValidationError):
            CatalogCourseBase(course_code="CS101", course_name="", department_code="CS")

    def test_course_name_with_special_characters(self):
        """Prueba que el nombre pueda contener caracteres especiales."""
        course = CatalogCourseBase(
            course_code="CS101", course_name="Introducción a la Programación I & II", department_code="CS"
        )
